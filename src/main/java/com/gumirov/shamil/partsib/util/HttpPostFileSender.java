...
public class HttpPostFileSender {
  ...
  public boolean onOutput(String filename, String priceHookId, byte[] file, int length, int partLen, String mid) throws IOException {
    ...
    try {
      ...
      while (part < totalParts) {
        ...
        sendPart(filename, priceHookId, b, len, part, totalParts, uuid, httpclient, mid);
        ++part;
      }
      return true;
  ...
  public boolean send(String filename, String pricehookId, InputStream is, int length, int partLen, String mid) throws IOException {
    CloseableHttpClient httpclient = HttpClients.createDefault();
  ...
  private void sendPart(String filename, String priceHookId, byte[] b, int len, int part, int totalParts, String uuid,
                        CloseableHttpClient httpclient, String mid) throws IOException, IllegalStateException {
