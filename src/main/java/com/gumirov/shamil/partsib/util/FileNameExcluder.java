...
/**
 * Interface used when need to filter out files by name. Note: pay attention to reversed logics (TRUE means DO NOT USE FILE LATER, FALSE means USE FILE IN LATER PROCESSING).
 */
